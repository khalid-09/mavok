...
const Footer = async () => {
  ...
  return (
    <footer className="space-y-8 px-4 py-10 md:space-y-16 md:px-30 md:pb-12 md:pt-20">
      <div className="customFooter:flex-col flex w-full flex-row gap-8 md:gap-14">
        <div className="grid w-full grid-cols-2 gap-8 lg:grid-cols-4">
          {footerLinks.map((link) => (
            <div key={link.id} className="flex w-full flex-col gap-3 md:gap-4">
