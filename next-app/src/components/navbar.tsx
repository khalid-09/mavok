...
import { HeroSection } from "@/lib/types/homepage";
        ...
        <nav className="block customNav:hidden">
          <ul className="flex items-center gap-6">
            {navLinks.map((link, index) => (
              <li
                key={index}
                className="-tracking--1% p-2 font-bold uppercase transition-all duration-300 hover:scale-105"
              >
